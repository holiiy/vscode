...
def show_start(console: Console) -> None:
    console.rule("欢迎使用该做题脚本,本脚本由微酸云生态赞助提供，开源免费，必应搜索微酸云")
    console.print("官方网站http://app.educlub.icu", justify="center")

    console.print("[red]注意：该脚本仅供学习参考,可投稿至邮箱839870068@qq.com,详细信息请参考官方群：624096199")
